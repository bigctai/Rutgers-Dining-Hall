...
struct BrowerView: View{
            ...
            ZStack{
                ...
                VStack{
                    Rectangle()
                        ...
                        .overlay(Text("BROWER").font(.custom("Odor Mean Chey Regular", size: 36)).foregroundColor(Color(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1))).multilineTextAlignment(.center).shadow(color: Color(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.25)), radius:4, x:3, y:4)
                        )
                        .padding(.bottom, 50.0)
                        .compositingGroup()
    ...
    struct BrowerView_Previews: PreviewProvider {
