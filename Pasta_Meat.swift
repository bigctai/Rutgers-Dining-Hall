...
struct Pasta_Meat: View{
    ...
    @State var drinks: [String] = ["Chicken", "Shrimp"]
    ...
    var body: some View{
        ...
        List{
            ScrollView{
            ForEach(drinks, id:\.self){ meat in
                ...
                Button(action:{showingPopover = true}){
                    ...
                    Text(meat).font(.custom("Odor Mean Chey Regular", size: 24)).foregroundColor(Color(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1))).multilineTextAlignment(.center)
                }
        ...
        .frame(height: 550)
        .offset(y: -20)
        .navigationTitle("Pasta Meat")
        .navigationBarItems(trailing: NavigationLink(destination: Pasta_and_Sauce(), label: {HStack{
...
struct Pasta_Meat_Previews: PreviewProvider {
