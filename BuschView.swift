...
struct BuschView: View{
            ...
            ZStack{
                ...
                VStack{
                    Rectangle()
                        ...
                        .overlay(Text("BUSCH DINING HALL").font(.custom("Odor Mean Chey Regular", size: 36)).foregroundColor(Color(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1))).multilineTextAlignment(.center).shadow(color: Color(#colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.25)), radius:4, x:3, y:4)
                        )
                        .padding(.bottom, 50.0)
                        .compositingGroup()
                    ...
                    ScrollView {
                        ...
                        ZStack {
                            ...
                            NavigationLink(
                                ...
                                label:{
                                    Text("Stir Fry").font(.custom("Odor Mean Chey Regular", size: 24)).foregroundColor(Color(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1))).multilineTextAlignment(.center)
                                }
                            )
                        }
                        .frame(width: 318, height: 100)
                        ...
                        Group {
                            ...
                            ZStack {
                                ...
                                NavigationLink(
                                    ...
                                    label:{
                                        Text("Sandwich Bar").font(.custom("Odor Mean Chey Regular", size: 24)).foregroundColor(Color(#colorLiteral(red: 1, green: 1, blue: 1, alpha: 1))).multilineTextAlignment(.center)
                                    }
                                )
                            }
                            .frame(width: 318, height: 100)
    ...
    struct BuschView_Previews: PreviewProvider {
